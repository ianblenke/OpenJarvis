...
class TestTaintSet:
    @pytest.mark.spec("REQ-security.taint.labels")
...
class TestCheckTaint:
    ...
    @pytest.mark.spec("REQ-security.taint.sink-policy")
...
class TestAutoDetect:
    @pytest.mark.spec("REQ-security.taint.auto-detect")
    @pytest.mark.spec("REQ-security.taint.labels")
...
class TestPropagate:
    @pytest.mark.spec("REQ-security.taint.propagation")
