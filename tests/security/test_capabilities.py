...
class TestCapability:
    @pytest.mark.spec("REQ-security.capabilities.rbac")
...
class TestCapabilityPolicy:
    ...
    @pytest.mark.spec("REQ-security.capabilities.deny-precedence")
    ...
    @pytest.mark.spec("REQ-security.capabilities.glob-patterns")
