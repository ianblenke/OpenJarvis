...
class TestSecretScanner:
    @pytest.mark.spec("REQ-security.scanner.protocol")
...
class TestPIIScanner:
    @pytest.mark.spec("REQ-security.scanner.pii")
...
class TestScanResult:
    @pytest.mark.spec("REQ-security.types.threat-level")
    @pytest.mark.spec("REQ-security.types.scan-result")
